...
execute if score $hit_remote_detonator_check copypack.remote_detonator.dummy matches 1 on vehicle at @s run playsound minecraft:block.iron.hit block @a ~ ~ ~ 1 1
execute if score $hit_remote_detonator_check copypack.remote_detonator.dummy matches 1 on vehicle at @s run particle minecraft:item{item:"minecraft:netherite_block"} ~ ~-0.25 ~ 0.3 0.1 0.3 0.1 5